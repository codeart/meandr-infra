...
output "node_role_arn" { value = data.aws_iam_role.node.arn }
output "task_execution_role_arn" { value = data.aws_iam_role.task_execution.arn }
output "instance_profile_arn" { value = data.aws_iam_instance_profile.node.arn }
